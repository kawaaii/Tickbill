 ...
 * @author hridaya
 */
public class CreateJasperReport extends javax.swing.JFrame {

    /**
     * Creates new form CreateJasperReport
     */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3307/pos", "root", "root");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateJasperReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
